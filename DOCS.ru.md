**русский** | [english](https://github.com/yandex-cloud/yfm-transform/blob/master/DOCS.md)
- - -
...
### Список определений <a name="def_list"></a>

Чтобы оформить список определений (`<dl>`) используйте символ `:`. В описании определения можно использовать любой YFM
синтаксис. Допустимы вложенные списки определений.
...
Условные операторы: `if`, `elsif`, and `else`. 
