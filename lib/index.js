...
function transform(originInput, opts = {}) {
    ...
    plugins.forEach((plugin) => {
        let pluginOptions = pluginCommonOptions;
        if (typeof plugin.displayName === 'string' && typeof pluginCommonOptions[plugin.displayName] === 'object') {
            pluginOptions = {
                ...pluginCommonOptions,
                ...pluginCommonOptions[plugin.displayName],
            };
        }
