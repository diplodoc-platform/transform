...
const {notes, attrs, anchors, code, cut, deflist, imsize, meta, sup, tabs} = plugins;
...
function transform(originInput, opts = {}) {
    const {
        ...
        plugins = [attrs, meta, deflist, cut, notes, anchors, tabs, code, imsize, sup], highlightLangs = {},
        ...customOptions
    } = opts;
    const pluginOptions = {
        ...customOptions,
