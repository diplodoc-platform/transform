...
const addTitle = ({
    hash, file, state, opts, isEmptyLink, tokens, idx, nextToken, href, currentPath, log, needSkipLinkFn,
}) => {
    ...
    if (title) {
        ...
        textToken.prevContent = '{#T}';
    } else if (!(needSkipLinkFn && needSkipLinkFn(href))) {
